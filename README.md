...
| OpenClaw | `~/.openclaw/skills/industry-research/` | `openclaw skills list` 确认发现后，`/skill industry-research <任务>`；也可 `openclaw skills install git:jiguang9/industry-research@v0.1.6` | 见 [docs/platform-compatibility.md](docs/platform-compatibility.md) |
